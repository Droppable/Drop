var Drop = function () {
    ...
    */
    ...
    this.isRegistered = function (selector) {
        ...
        if (/*typeof selector !== undefined &&*/ typeof selector != 'undefined') {
            ...
            if ($(selector).length) {
                ...
                // Reassign drop id
                selector = /*typeof _dropId !== undefined*/typeof _dropId != 'undefined' ? _dropId : '';
            }
    ...
    this.isValidDom = function (selector) {
        ...
        if (/*typeof selector !== undefined*/typeof selector != 'undefined' && typeof selector == 'string') {
            var _drop = _self.DOM(selector);
            if (_drop && _drop.length && /*typeof _drop !== undefined*/typeof _drop != 'undefined') {
            ...
            if (typeof _data != 'undefined' && _data.id != '' && typeof _data.id != 'undefined') {
                ...
                if (typeof _selector != 'undefined') {
                    ...
                    if (_selector.drop.filter('[data-drop-onhover]').length) {
                        ...
                        _selector.dropTrigger.click(function () {
                            _self.toggleDom(_data, selector);
    ...
    if (/*typeof selector !== undefined && */typeof selector != 'undefined' && typeof selector == 'string') {
        ...
        // Register Drop through the markup in the DOM
            ...
            if (_self.isValidDom(_selector) && !_self.isRegistered(_selector)) {
                ...
                //console.log(_data)
                if (/*typeof _data !== undefined*/typeof _data != 'undefined' && _data.enable ==  0) {
                    _data.enable = 1;
                } else {
        ...
        for (var i = 0; i < _self.selector.length; i++) {
            ...
            if (_dropId == 'undefined') {
                var _drop = _self.selector[i];

                // Create data row from DOM
                _self.insertDataRow(_drop);

                //console.log(typeof _drop)

                // Get the drop id from DOM once we have registered all of the drops
                var _dropId = $(_self.selector[i]).data('drop-id');

                //console.log('Register ' + _dropId)
            ...
            //console.log($(_self.selector[i]).data('drop-id'))
        }
        */
        /*
        ///////////////////////////////////////////////////////////////////////////////////
        ...
        if (_unregisteredSelector.length > 0) {
            
            console.info('Drop: ' + _unregisteredSelector.length + ' drops not yet registered which we will register now.');
            ...
            // Just recache drops
            _self.selector = $('.drop');
            console.warn('Drop: No new drop found in the DOM to register.');
        }
        ///////////////////////////////////////////////////////////////////////////////////
            ///////////////////////////////////////////////////////////////////////////////////
            */
