var Drop = function () {
    ...
    */
    ...
    this.insertDataRow = function (selector) {
        ...
        if (typeof selector != 'undefined' /*&& typeof selector !== undefined*/ && _self.isRegistered(selector) == false) {
    ...
    this.onChange = function (handler, selector) {
        ...
        if (typeof handler != 'undefined' && typeof selector != 'undefined' && _self.isValidDom(selector)) {
            ...
            if (typeof _data != 'undefined' && _data.id != '' && typeof _data.id != 'undefined') {
                ...
                if (typeof _selector != 'undefined') {
                    ...
                    if (_selector.drop.filter('[data-drop-onhover]').length) {
                        //_selector.drop.unbind('hover.dropHover').bind('hover.dropHover', function () {
                        _selector.drop.hover(function () {
                    ...
                    // onClick
                        ...
                        //_selector.dropTrigger.unbind('click.dropClick').bind('click.dropClick', function () {
                        _selector.dropTrigger.on('click', function () {

                            console.log(_selector, selector)
                    ...
                    if (_selector.dropClose.length) {
                        //_selector.dropClose.unbind('click.dropClose').bind('click.dropClose', function () {
                        _selector.dropClose.click(function () {
                            _self.toggleDom(_data, selector);
                        });
                    }
                }
    ...
    // Register all the drops found in the DOM
        ...
        if (_self.selector.not('[data-drop-id]').length) {
            ...
            for (var i = 0; i < _unregisteredSelector.length; i++) {
                ...
                //console.log(_self.selector[i])

                // Get the drop id from DOM
                var _dropId = $(_self.selector[i]).data('drop-id');

                //console.log(_dropId)
                //console.log(_self.isValidDom(_dropId), _self.isRegistered(_dropId))
            ...
            // Recheck to make sure there is not a single drop that's not registered
            //_self.register();
